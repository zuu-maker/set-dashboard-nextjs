      ...
      <div className="bg-white p-6  md:mx-auto">
        ...
        <div className="text-center">
            ...
            <Typewriter
              onInit={(typewriter) => {
                typewriter
                  ...
                  .changeDelay(70)
                  .typeString(
                    "Please Naviagte Back to the App to Start Learning 👩‍🎓."
                  )
                  .callFunction(() => {
          ...
          <p className="text-gray-600 mb-2 mt-5">
            Thank you for completing your secure online payment, Your Payment
            has been verified and your course has been added to your courses
            Tab.
          </p>
          <p>
            {" "}
